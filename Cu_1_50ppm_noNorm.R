...
# ------------------------------
# Reorder facets so 50 ppm is on top
# ------------------------------
df_long$Condition <- factor(df_long$Condition, levels = c("50 ppm", "25 ppm", "10 ppm", "5 ppm", "2.5 ppm", "1 ppm"))
...
ggsave("Cu_1_50ppm_noNorm_faceted.png", p, width = 10, height = 8, dpi = 300)
